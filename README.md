...
- 🌍 Multiple language options (English, Spanish, French -- more coming)
- 🏆 Adjustable difficulty levels (Easy, Medium, Hard)
- 🔄 Unlimited retries for endless word-guessing fun
...
```bash
git clone https://github.com/arandito/international-wordle.git
cd international-wordle
```
